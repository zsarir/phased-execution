...
Prefer to do it by hand? → **[docs/install.md](docs/install.md)**
...
Needs Claude Code, plus `bash` and `git`. The console adds Node 22+ and has **no runtime
dependencies**. MIT — see [LICENSE](LICENSE).
