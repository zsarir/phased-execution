    ...
    <Card>
      ...
      <CardBody className="flex flex-col gap-3">
        <p className="text-sm text-ink-muted">
          The exact line for this console — its source directory, its port, all five switches (writes, runs,
          terminal, agent, accounts), and every setting it was started with (remote access, session ceiling,
          default skills). Paths are <code>$HOME</code>-relative, so the line is portable and screenshots
          carry no username.
        </p>
        ...
        <p className="text-2xs text-ink-faint">
          Supervised by launchd? The flags live in the agent's plist — the Desktop launcher card below writes
          a launcher with the full set, and re-running it re-installs the agent. Deliberately not composed:{' '}
          <code>--host</code> (the console binds localhost, always), <code>--instance</code>,{' '}
          <code>--scripts</code> and <code>--log-file</code> — install-shaped flags the guide's reference
          table covers.
        </p>
      </CardBody>
    </Card>
