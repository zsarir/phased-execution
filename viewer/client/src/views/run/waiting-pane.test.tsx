...
function detail(): PlanDetail {
  return {
    ...
    phases: [
      ...
      {
        phase: 10, title: 'the docs', state: 'waiting', gated: false, bullets: [],
        analysis: { phase: 10, state: 'waiting', size: 'M', weight: 1, dependsOn: [7, 9], dependents: [], transitiveDependents: [], unblocks: 0, onCriticalPath: false },
      },
      {
        phase: 11, title: 'the release', state: 'waiting', gated: true, gates: 'phase 10 verified', bullets: [],
        analysis: { phase: 11, state: 'waiting', size: 'S', weight: 1, dependsOn: [10], dependents: [], transitiveDependents: [], unblocks: 0, onCriticalPath: false },
      },
    ],
